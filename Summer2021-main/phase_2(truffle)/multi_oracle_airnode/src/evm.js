...
module.exports = {
  ...
  TransferRequestClientArtifact: require('../build/contracts/TransferRequestClient.json'),
  GasPriceClientArtifact: require('../build/contracts/GasPriceClient.json'),
  WeatherClientArtifact: require('../build/contracts/WeatherClient.json')
};
