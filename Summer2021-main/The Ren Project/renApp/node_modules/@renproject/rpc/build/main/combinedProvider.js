...
class CombinedProvider {
    constructor(network, logger = interfaces_1.NullLogger) {
        ...
        switch (this.network.name) {
            ...
            case interfaces_1.RenNetwork.MainnetVDot3:
                v1Network = interfaces_1.RenNetwork.Mainnet;
                v2Network = interfaces_1.RenNetwork.MainnetVDot3;
                break;
            case interfaces_1.RenNetwork.Testnet:
            case interfaces_1.RenNetwork.Testnet:
            case interfaces_1.RenNetwork.TestnetVDot3:
            case interfaces_1.RenNetwork.TestnetVDot3:
                v1Network = interfaces_1.RenNetwork.Testnet;
                v2Network = interfaces_1.RenNetwork.TestnetVDot3;
                break;
            case interfaces_1.RenNetwork.DevnetVDot3:
            case interfaces_1.RenNetwork.DevnetVDot3:
                v2Network = interfaces_1.RenNetwork.DevnetVDot3;
                break;
            default:
                v1Network = network;
                v2Network = network;
        ...
        if (v1Network) {
            this.v1 = new v1_1.RenVMProvider(v1Network, undefined, logger);
        }
        this.v2 = new v2_1.RenVMProvider(v2Network, undefined, logger);
