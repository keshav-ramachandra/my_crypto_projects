...
exports.renFantomTestnet = {
    ...
    explorer: networks_1.StandardExplorer("https://testnet.ftmscan.com"),
...
exports.renFantomMainnet = {
    ...
    explorer: networks_1.StandardExplorer("https://ftmscan.com"),
    /** @deprecated Renamed to publicProvider. Will be removed in 3.0.0. */
...
class FantomClass extends ethereum_1.EthereumClass {
    constructor(web3Provider, renNetwork) {
        ...
        this.configMap = exports.FantomConfigMap;
...
FantomClass.configMap = exports.FantomConfigMap;
FantomClass.utils = {
