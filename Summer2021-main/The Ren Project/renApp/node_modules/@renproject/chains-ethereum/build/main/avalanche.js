...
exports.AvalancheConfigMap = {
    [interfaces_1.RenNetwork.TestnetVDot3]: exports.renAvalancheTestnet,
    [interfaces_1.RenNetwork.MainnetVDot3]: exports.renAvalancheMainnet,
};
const resolveAvalancheNetwork = (renNetwork) => {
    if (!renNetwork) {
        return exports.AvalancheConfigMap[interfaces_1.RenNetwork.MainnetVDot3];
    }
