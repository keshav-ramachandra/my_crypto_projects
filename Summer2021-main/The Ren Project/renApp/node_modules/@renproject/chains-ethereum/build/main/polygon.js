...
exports.renPolygonTestnet = {
    ...
    explorer: networks_1.StandardExplorer("https://explorer-mumbai.maticvigil.com"),
...
exports.PolygonConfigMap = {
    [interfaces_1.RenNetwork.TestnetVDot3]: exports.renPolygonTestnet,
    [interfaces_1.RenNetwork.MainnetVDot3]: exports.renPolygonMainnet,
};
const resolvePolygonNetwork = (renNetwork) => {
    if (!renNetwork) {
        return exports.PolygonConfigMap[interfaces_1.RenNetwork.MainnetVDot3];
    }
