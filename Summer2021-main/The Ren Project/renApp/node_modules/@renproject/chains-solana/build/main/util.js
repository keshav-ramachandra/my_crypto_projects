...
exports.createInstructionWithEthAddress2 = exports.toBuffer = void 0;
 ...
 * */
function createInstructionWithEthAddress2(params) {
    ...
    utils_1.assert(ethAddress.length === ETHEREUM_ADDRESS_BYTES, `Address must be ${ETHEREUM_ADDRESS_BYTES} bytes but received ${ethAddress.length} bytes`);
