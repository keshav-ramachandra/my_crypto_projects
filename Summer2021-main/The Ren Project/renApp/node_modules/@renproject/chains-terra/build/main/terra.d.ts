...
export declare class TerraClass implements LockChain<TerraTransaction, TerraDeposit, TerraAddress, TerraNetwork> {
    ...
    assets: TerraAssets[];
    static utils: {
        resolveChainNetwork: (network: RenNetworkDetails | RenNetwork | "mainnet" | "testnet" | "mainnet-v0.3" | "testnet-v0.3" | "devnet-v0.3" | "localnet" | TerraNetwork) => TerraNetwork.Tequila | TerraNetwork | TerraNetwork.Columbus;
