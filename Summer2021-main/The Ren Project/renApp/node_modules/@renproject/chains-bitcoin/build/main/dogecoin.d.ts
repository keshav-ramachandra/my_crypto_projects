...
export declare class DogecoinClass extends BitcoinClass {
    static chain: string;
    chain: string;
    name: string;
...
export declare type Dogecoin = DogecoinClass;
export declare const Dogecoin: import("@renproject/utils").CallableConstructor<typeof DogecoinClass>;
