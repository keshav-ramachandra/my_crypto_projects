...
class BitcoinBaseChain {
    constructor(network) {
        ...
        this.transactionFromRPCFormat = async (txid, txindex, reversed) => {
        ...
        this.transactionRPCTxidFromID = (transactionID, v2) => v2 ? utils_1.fromHex(transactionID).reverse() : utils_1.fromHex(transactionID);
        /**
