...
export declare class ZcashClass extends BitcoinClass {
    static chain: string;
    chain: string;
    name: string;
    legacyName: string;
...
export declare type Zcash = ZcashClass;
export declare const Zcash: import("@renproject/utils").CallableConstructor<typeof ZcashClass>;
