...
export declare class DigiByteClass extends BitcoinClass {
    static chain: string;
    chain: string;
    name: string;
...
export declare type DigiByte = DigiByteClass;
export declare const DigiByte: import("@renproject/utils").CallableConstructor<typeof DigiByteClass>;
