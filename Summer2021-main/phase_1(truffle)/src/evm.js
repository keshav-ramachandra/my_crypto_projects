...
module.exports = {
  ...
  ShortRequestClientArtifact: require('../build/contracts/ShortRequestClient.json'),
  FullRequestClientArtifact: require('../build/contracts/FullRequestClient.json'),
  RegularRequestClientArtifact: require('../build/contracts/RegularRequestClient.json'),
};
