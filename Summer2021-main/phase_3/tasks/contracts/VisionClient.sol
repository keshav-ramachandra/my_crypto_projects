...
contract VisionClient is AirnodeClient,Ownable{
    string public place;
    ...
    function getVisionUpdate(bytes32 providerId,bytes32 endpointId,uint requesterInd,address designatedWallet,bytes calldata parameters) external
    {
