// Bina Token and Exchange Contracts
...
module.exports       = async function(callback) {
  try {
    ...
    // Fetch the deployed Bina token
    const token      = await Token.deployed()
    console.log('Bina Token fetched', token.address)

    // Fetch the deployed Bina exchange
    const exchange   = await Exchange.deployed()
    console.log('Bina Exchange fetched', exchange.address)
